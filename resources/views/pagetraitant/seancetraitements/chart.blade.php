    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function drawChart()
            {
                ...
                var options = {
                    title : 'منحنى تطور حالة الطفل في الحصص خلال شهر فيفري',
                    hAxis: {
                        title: 'شهر فيفري',format: '0',
        ...
        <script type="text/javascript">
            ...
            function drawChart()
            {
                ...
                var options = {
                    title : 'منحنى تطور حالة الطفل في الحصص خلال شهر مارس',
                    hAxis: {
                        title: 'شهر مارس',format: '0',
        ...
        <script type="text/javascript">
            ...
            function drawChart()
            {
                ...
                var options = {
                    title : 'منحنى تطور حالة الطفل في الحصص خلال شهر افريل',
                    hAxis: {
                        title: 'شهر افريل',format: '0',
                    },
                    vAxis: {
                        title: 'التقييم',format: '0',
                        viewWindow: {
        ...
        <script type="text/javascript">
            ...
            function drawChart()
            {
                ...
                var options = {
                    title : 'منحنى تطور حالة الطفل في الحصص خلال شهر ماي',
                    hAxis: {
                        title: 'شهر ماي',format: '0',
        ...
        <script type="text/javascript">
            ...
            function drawChart()
            {
                ...
                var options = {
                    title : 'منحنى تطور حالة الطفل في الحصص خلال شهر سبتمبر',
                    hAxis: {
                        title: 'شهر سبتمبر',format: '0',
        ...
        <script type="text/javascript">
            ...
            function drawChart()
            {
                ...
                var options = {
                    title : 'منحنى تطور حالة الطفل في الحصص خلال شهر اكتوبر',
                    hAxis: {
                        title: 'شهر اكتوبر',format: '0',
        ...
        <script type="text/javascript">
            ...
            function drawChart()
            {
                ...
                var options = {
                    title : 'منحنى تطور حالة الطفل في الحصص خلال شهر نوفمبر',
                    hAxis: {
                        title: 'شهر نوفمبر',format: '0',
        ...
        <script type="text/javascript">
            var analyticsdateyear = <?php echo $dateyear; ?>
            ...
            function drawChart()
            {
                var datadateyear= google.visualization.arrayToDataTable(analyticsdateyear);
                var options = {
                    title : 'منحنى تطور حالة الطفل خلال الاعوام',
                    hAxis: {
                        title: 'الاعوام', format: '0',
                ...
                var chart = new google.visualization.LineChart(document.getElementById('line_chartdateyear'));
                chart.draw(datadateyear, options);
            }
        </script>
    </head>
    <body>
    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" align="center">
                <h3>احصائيات التطور في الحصص</h3></div></div>
            <br><br><br><br>
            <div class="row">
                <div class="col-md-6">   <div id="line_chart" style="width:550px; height:350px;"></div></div>
                    <div class="col-md-6"> <div id="line_chartdateyear" style="width:450px; height:350px;"></div>
                        </div>
                </div>
        </div>

            <div class="row">
            <div class="col-md-6"><div id="line_chartdatejanvier" style="width:450px; height:350px;"></div></div>
